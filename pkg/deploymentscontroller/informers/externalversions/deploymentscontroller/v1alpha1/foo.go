...
import (
	...
	deploymentscontroller_v1alpha1 "github.com/mjudeikis/ocp-controller/pkg/apis/deploymentscontroller/v1alpha1"
	versioned "github.com/mjudeikis/ocp-controller/pkg/deploymentscontroller/clientset/versioned"
	internalinterfaces "github.com/mjudeikis/ocp-controller/pkg/deploymentscontroller/informers/externalversions/internalinterfaces"
	v1alpha1 "github.com/mjudeikis/ocp-controller/pkg/deploymentscontroller/listers/deploymentscontroller/v1alpha1"
...
func NewFilteredFooInformer(client versioned.Interface, namespace string, resyncPeriod time.Duration, indexers cache.Indexers, tweakListOptions internalinterfaces.TweakListOptionsFunc) cache.SharedIndexInformer {
	return cache.NewSharedIndexInformer(
		...
		&deploymentscontroller_v1alpha1.Foo{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *fooInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&deploymentscontroller_v1alpha1.Foo{}, f.defaultInformer)
}
